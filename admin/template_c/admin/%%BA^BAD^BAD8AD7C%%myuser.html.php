<?php /* Smarty version 2.6.31, created on 2018-03-14 05:22:21
         compiled from myuser.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'myuser.html', 31, false),)), $this); ?>
...
<input type="hidden" name="user_id" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['user']['user_id'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
">